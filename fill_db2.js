...
async function run() {
    ...
    console.log(`Fetching quick fallback items for "batik"...`);
    const res = await fetchWithDelay('https://collectionapi.metmuseum.org/public/collection/v1/search?hasImages=true&q=batik');
